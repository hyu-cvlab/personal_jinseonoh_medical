...
from Prostate_test_3D_util_2task import test_all_case
...
#     val_files = load_decathlon_datalist(datasets, True, args.phase)
    ...
    directory_path = "/data/hanyang_Prostate/50_example/trim/sl_data_wo_norm_morphology_5/centerCrop_350_350_200/label_trim/"
    mask_voxel_counts = []
    pixel_spacing_xs = []
    pixel_spacing_ys = []
    slice_gaps = []
